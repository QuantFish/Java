...
public class MonteCarloPrices {
	...
	public double[] simValue(double mean, double sd, double initialvalue,
			double time) {
	...
	public double[] simValueP(double mean, double sd, double initialvalue,
			double time) {
		double[] simvalues = new double[iterations];
		ItoProcess ito = new ItoProcess();
		double change;
	...
	public double[] simValueUp(double mean, double sd, double initialvalue,
