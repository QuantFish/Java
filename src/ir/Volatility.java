...
public class Volatility {
	...
	public void yieldForPpoint(double couponpercent, double price,
			double maturity, double estimate, double pointvalue) {
		...
		// estimate))));
		setInitialYldPp(CalcBond.yield(facevalue, couponterm, couponpercent,
				price, maturity));
		setdownyieldPp(Math.abs((CalcBond.yield(facevalue, couponterm,
				couponpercent, getPricedownPp(), maturity))));
